...
3) Before we run it, let me explain the code briefly:
...
4) Now we can execute the executable file by using `./threader`, with the result shown below:
...
5) Let us leave that program running and look at our list of running processes and threads.
